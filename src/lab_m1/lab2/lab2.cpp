...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0.75, 0, 0.25)),
    ...
    // by definition!
    {
        vector<VertexFormat> tetra_vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1,  2), glm::vec3(1, 0, 1)),
        ...
        CreateMesh("tetrahedron", tetra_vertices, tetra_indices);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> sq_vertices
        {
            ...
            VertexFormat(glm::vec3(1, 3,  0), glm::vec3(0, 0, 1)),
            VertexFormat(glm::vec3(3, 1,  0), glm::vec3(0, 1, 0)),
            VertexFormat(glm::vec3(3, 3,  0), glm::vec3(0, 0, 1))
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, -0.25f, 0), glm::vec3(0.25f));
    ...
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 1, 0), glm::vec3(0.25f));
