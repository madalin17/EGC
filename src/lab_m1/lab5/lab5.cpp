...
{
    proMatrix = glm::perspective(RADIANS(fov), window->props.aspectRatio, 0.01f, 200.0f);
    ortoMatrix = glm::ortho(lft, rght, bottom, top, 0.01f, 200.0f);

    projectionMatrix = po ? proMatrix : ortoMatrix;
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-1, 1.5f, 0));
        glm::rotate(modelMatrix, RADIANS(30.0f), glm::vec3(1, 0, 0));
...

    {
        ...
        //modelMatrix = glm::rotate(modelMatrix, glm::vec4(...));
